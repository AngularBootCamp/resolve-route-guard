# DRAFT - Angular Boot Camp Curriculum - resolve-route-guard
...
[StackBlitz for resolve-route-guard](https://stackblitz.io/github/AngularBootCamp/resolve-route-guard)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/resolve-route-guard.git
cd resolve-route-guard
yarn
yarn start
```
